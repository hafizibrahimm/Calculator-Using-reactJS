                    ...
                    <div class="card mb-3 pt-3 shadow">
                        <div class="card-body text-dark">
                            ...
                            <div className="row">
                                ...
                                <div className="col-3">
                                    <button className="btn btn-light text-dark shadow px-2 py-4 fs-4" value="C" onClick={(e)=>backspace()}>CE/C</button>
                                </div>
                            </div>
                            ...
                            <div className="container">
                                <div className="row mt-2">
                                    <button className="btn btn-light text-dark shadow p-1 fs-2" value="=" onClick={()=>calculate()}>=</button>
                                </div>
                            </div>
